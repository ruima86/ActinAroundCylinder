...
Filament::Filament(vec3 com, vec3 ort, vec3 rot, double len, int ind)        // overload constructor with center_of_mass as parameter
{

    center_of_mass = com;
    orientation = ort;               // random orientation
    rotation = rot;                  // perpendicular to orientation
